...
public class Prestamo {
  ...
  public Prestamo(Usuario u, Ejemplar e, LocalDate f) {
    this.usuario = u;
    this.ejemplar = e;
  ...
  public void setFechaVence(LocalDate f) {
    this.fechaVence = f;
  }
  ...
  public void setEstado(PrestamoEstado e) {
    this.estado = e;
  }
  ...
  public void setMulta(BigDecimal m) {
    this.multa = m;
  }
}